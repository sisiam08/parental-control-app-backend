...
class NotificationsController {
    ...
    async triggerSOS(req, res, next) {
        try {
            ...
            const sos = await notificationsService.triggerSOS(deviceId, childId, latitude !== undefined ? Number(latitude) : undefined, longitude !== undefined ? Number(longitude) : undefined);
    ...
    async respondCheckIn(req, res, next) {
        try {
            const deviceId = req.device?.id;
            ...
            const checkIn = await notificationsService.respondCheckIn(deviceId, checkInId, latitude !== undefined ? Number(latitude) : undefined, longitude !== undefined ? Number(longitude) : undefined);
